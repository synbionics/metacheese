...
output_base_dir="../../data/processed/05_spades_output/temporanea"     # cartella dove creare sottocartelle per ogni campione
campioni_folder="../../data/processed/03_Bowtie2_output"     # cartella con file .fq.1.gz e .fq.2.gz
threads="32"              # numero di thread
memory="64"               # memoria RAM in GB
