...
mkdir -p /hpc/group/G_MICRO/DOPnonDOP_noema/04_spades_output/temporanea
cd /hpc/group/G_MICRO/DOPnonDOP_noema/04_spades_output/temporanea 
#creata in precedenza

module load spades/3.13.0

campioni_folder="/hpc/group/G_MICRO/DOPnonDOP_noema/02_Bowtie2_output" 
output_folder="/hpc/group/G_MICRO/DOPnonDOP_noema/04_spades_output/temporanea"
